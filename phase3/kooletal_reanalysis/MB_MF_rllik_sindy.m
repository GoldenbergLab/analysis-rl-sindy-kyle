...
for t = 1:N
    ...
    dtQ(1) = rc*Qd(state2,subdata.choice2(t)) - qc*(Qd(1,subdata.choice1(t))^2);                                   % backup with actual choice (i.e., sarsa)
    Qd(1,subdata.choice1(t)) = Qd(1,subdata.choice1(t)) + dtQ(1);                                % update TD value function
     
    dtQ(2) = rc*subdata.win(t) - qc*(Qd(state2,subdata.choice2(t))^2);                                                          % prediction error (2nd choice)
    
    Qd(state2,subdata.choice2(t)) = Qd(state2,subdata.choice2(t)) + dtQ(2);                                % update TD value function
    Qd(1,subdata.choice1(t)) = Qd(1,subdata.choice1(t)) + lambda*dtQ(2);                         % eligibility trace
